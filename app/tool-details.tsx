          ...
          <View className="bg-[#141A24] rounded-xl p-4 mb-4">
            ...
            <View className="flex-row gap-3">
              <TouchableOpacity
                ...
                className={`flex-1 py-2.5 rounded-lg items-center ${threatLevel === "routine" ? "bg-[#2E8B57]" : "bg-[#1A2230] border border-[#2D3748]"
                  }`}
              >
              ...
              <TouchableOpacity
                ...
                className={`flex-1 py-2.5 rounded-lg items-center ${threatLevel === "elevated" ? "bg-[#D82C15]" : "bg-[#1A2230] border border-[#2D3748]"
                  }`}
              >
